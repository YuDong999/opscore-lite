...
func CoreModules() []Manifest {
	return []Manifest{
		...
		{ID: "diagnostics", Name: "系统诊断", Icon: "activity", RoutePath: "/diagnostics", Group: "plugin", Description: "网络诊断 / 登录审计 / 系统更新"},
		{ID: "tasks", Name: "任务与存储", Icon: "clipboard", RoutePath: "/tasks", Group: "plugin", Description: "定时任务 / 磁盘挂载 / SMART 健康"},
