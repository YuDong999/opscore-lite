...
var logPaths = map[string][]string{
	...
	"mysql":         {"/var/log/mysql/error.log", "/var/log/mysql/mysqld.log", "/var/log/mysqld.log"},
	"mysqld":        {"/var/log/mysql/error.log", "/var/log/mysql/mysqld.log", "/var/log/mysqld.log"},
	"mariadbd":      {"/var/log/mariadb/error.log", "/var/log/mariadb/mariadb.log"},
	"mariadb":       {"/var/log/mariadb/error.log", "/var/log/mariadb/mariadb.log"},
	"postgres":      {"/var/log/postgresql/postgresql.log", "/var/lib/pgsql/data/log/postgresql.log"},
	"postmaster":    {"/var/log/postgresql/postgresql.log", "/var/lib/pgsql/data/log/postgresql.log"},
